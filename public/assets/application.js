...
!function ($) {
    ...
    var BootstrapDateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="bootstrapdaterangepicker dropdown-menu">' +
                '<div class="calendar left"></div>' +
                '<div class="calendar right"></div>' +
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    //'<div class="bootstrapdaterangepicker_start_input" style="float: left">' +
                    //  '<label for="bootstrapdaterangepicker_start">' + this.locale.fromLabel + '</label>' +
                    //  '<input class="input-mini" type="text" name="bootstrapdaterangepicker_start" value="" disabled="disabled" />' +
                    //'</div>' +
                    //'<div class="bootstrapdaterangepicker_end_input" style="float: left; padding-left: 11px">' +
                    //  '<label for="bootstrapdaterangepicker_end">' + this.locale.toLabel + '</label>' +
                    //  '<input class="input-mini" type="text" name="bootstrapdaterangepicker_end" value="" disabled="disabled" />' +
                    //'</div>' +
        ...
        this.container = $(DRPTemplate).appendTo('.bootstrap');
    ...
    BootstrapDateRangePicker.prototype = {
        ...
        updateView: function () {
            ...
            this.container.find('input[name=bootstrapdaterangepicker_start]').val(this.startDate.toString(this.format));
            this.container.find('input[name=bootstrapdaterangepicker_end]').val(this.endDate.toString(this.format));
        ...
        show: function (e) {
            ...
            {
                $("li:contains('"+globalLabel+"')").addClass("active");
            }
        ...
        enterRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                this.container.find('input[name=bootstrapdaterangepicker_start]').val(dates[0].toString(this.format));
                this.container.find('input[name=bootstrapdaterangepicker_end]').val(dates[1].toString(this.format));
            }
        },
        ...
        enterDate: function (e) {
            ...
            var title = $(e.target).attr('rowcol');
            var row = title.substr(1, 1);
            var col = title.substr(3, 1);
            var cal = $(e.target).parents('.calendar');

            if (cal.hasClass('left')) {
                this.container.find('input[name=bootstrapdaterangepicker_start]').val(this.leftCalendar.calendar[row][col].toString(this.format));
            } else {
                this.container.find('input[name=bootstrapdaterangepicker_end]').val(this.rightCalendar.calendar[row][col].toString(this.format));
            }
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    html += '<td class="' + cname.replace(/\s+/g,' ').replace(/^\s?(.*?)\s?$/,'$1') + '" rowcol="' + title + '">' + calendar[row][col].getDate() + '</td>';
                }
                html += '</tr>';
            }
  ...
  jQuery.fn.tagsManager = function (options,tagToManipulate) {
    ...
    var pushTag = function (tag) {
      ...
      if (alreadyInList) {
        ...
        var st = tagManagerOptions.tagStyle ? tagManagerOptions.tagStyle : '';
        html += '<span class="myTag'+cl+'" id="' + newTagId + '" style="' + st + '"><span>' + tag + '&nbsp;&nbsp;</span><a href="#" class="myTagRemover" id="' + newTagRemoveId + '" TagIdToRemove="' + tagId + '" title="Remove">' + tagManagerOptions.tagCloseIcon + '</a></span> ';
...
!function($) {
     ...
     * ================================== */
    var BootstrapTimepicker = function(element, options) {
        this.$element = $(element);
        this.options = $.extend({}, $.fn.bootstrap_timepicker.defaults, options, this.$element.data());
    ...
    BootstrapTimepicker.prototype = {

        constructor: BootstrapTimepicker
        ...
        , init: function () {
            ...
            if (this.inline) {
              this.$widget = this.$element.html(this.getTemplate());
            } else {
        ...
        , getTemplate: function() {
            ...
            if (this.showInputs) {
                var hourTemplate = '<input type="text" name="hour" class="bootstrap-timepicker-hour input-mini" maxlength="2"/>';
                var minuteTemplate = '<input type="text" name="minute" class="bootstrap-timepicker-minute input-mini" maxlength="2"/>';
                var secondTemplate = '<input type="text" name="second" class="bootstrap-timepicker-second input-mini" maxlength="2"/>';
                var meridianTemplate = '<input type="text" name="meridian" class="bootstrap-timepicker-meridian input-mini" maxlength="2"/>';
            } else {
            ...
            switch(this.options.template) {
                ...
                case 'dropdown':
                    template = '<div class="bootstrap-timepicker dropdown-menu">'+
                               ...
                               '</div>';
                case 'inline':
                    template = '<div class="bootstrap-timepicker">' +
                                    templateContent +
                               '</div>';
                break;
    ...
    $.fn.bootstrap_timepicker = function (option) {
        return this.each(function () {
            var $this = $(this)
            , data = $this.data('bootstrap_timepicker')
            , options = typeof option == 'object' && option;
            if (!data) {
                $this.data('bootstrap_timepicker', (data = new BootstrapTimepicker(this, options)));
            }
            if (typeof option == 'string') {
                data[option]();
            }
    ...
    $.fn.bootstrap_timepicker.defaults = {
      minuteStep: 15
    , secondStep: 15
    , disableFocus: false
    , defaultTime: 'current'
    ...
    $.fn.bootstrap_timepicker.Constructor = BootstrapTimepicker
}(window.jQuery);
(function() {
