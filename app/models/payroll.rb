class Payroll < ActiveRecord::Base
  attr_accessible :month, :year, :advance_salary, :basic, :daily, :employe, :esi, :gross, :hra, :medical, :net_salary, :other, :payroll_month_year, :pf, :professional_tax, :tds, :total_deductions, :total_working_days, :travel, :variable, :working_days
  belongs_to :user
